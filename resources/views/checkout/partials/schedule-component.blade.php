    ...
    <div class="mt-3 space-y-4">
        <ul class="grid grid-cols-7 gap-2">
            ...
            <li>
                ...
                <label for="{{ $week->name }}" class="block rounded-lg px-2 py-2 leading-3 border border-neutral-100 hover:bg-neutral-500 cursor-pointer peer-checked:border-green-700 text-center">
        ...
        <ul class="grid grid-cols-5 gap-2">
            ...
            <li>
                ...
                <label for="{{ $hour->time }}" class="block rounded-lg px-2 py-2 leading-3 border cursor-pointer hover:bg-neutral-100 peer-checked:border-green-700 text-center">
