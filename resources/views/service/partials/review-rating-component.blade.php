...
<article class="flex max-w-xl flex-col items-start justify-between my-6 bg-white p-4 rounded-lg">
    ...
    <p class="mt-2 line-clamp-3 text-sm/6 text-gray-900">{{ $review->comment }}</p>
