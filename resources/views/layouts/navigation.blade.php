    ...
    <div class="w-screen max-w-md flex-auto overflow-hidden rounded-3xl bg-white text-sm/6 shadow-lg ring-1 ring-gray-900/5">
        <div class="p-4">
            <div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-gray-50">
                ...
                <div>
                    <a href="{{ route('booking.index') }}" class="font-semibold text-gray-900">
                        My Bookings
            ...
            <div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-gray-50">
                ...
                <div>
                    <a href="{{ route('wishlist.index') }}" class="font-semibold text-gray-900">
                        Wishlist
                        <span class="absolute inset-0"></span>
                    </a>
            ...
            <div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-gray-50">
                ...
                <div>
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="font-semibold text-gray-900">
                            Logout
                            <span class="absolute inset-0"></span>
                        </button>
                        <p class="mt-1 text-gray-600">Build strategic funnels that will convert</p>
